    ...
    try:
        ...
        for _, row in fighters_df.iterrows():
            ...
            if wins > 0:
                ...
                if ((leg_landed_avg > 24.5) or (body_landed_avg > 25.5)) and (leg_landed_avg + body_landed_avg > 52) and (ko_tko_wins > 2) and (total_fights >= 5):
            ...
            if (sub_att_received_avg * total_fights >= 12) and (never_submitted == 1) and (total_fights >= 5):
